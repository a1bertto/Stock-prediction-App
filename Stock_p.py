...
def plot_raw_data():
    ...
    fig.layout.update(title_text='Historical data(open & close price) ', xaxis_rangeslider_visible=True)
    st.plotly_chart(fig)
...
st.markdown("### Stock prediction graph for {} years".format(n_years))
fig1 = plot_plotly(m, forecast)
st.plotly_chart(fig1)

st.write(" Prediction Data Components")
st.markdown("""
Forecast seasonal predictions:
Time series put to seasonal components(1week,1month,6months,1year)
""")
